...
const Applicants = () => {
  ...
  useEffect(() => {
    const fetchApplications = async () => {
      try {
        const response = await axios.get(`https://thrive-xbzt.onrender.com/api/company/jobs/${jobId}/applications`);
    ...
    const getJobTitle  = async () => {
      try{
        const response = await axios.get(`https://thrive-xbzt.onrender.com/api/company/jobs/${jobId}`);
  ...
  const handleStatusChange = async (developerId, newStatus) => {
    try {
      ...
      const apiEndpoints = {
        applied: {
          underProcess: "https://thrive-xbzt.onrender.com/api/company/applications/process",
          rejected: "https://thrive-xbzt.onrender.com/api/company/applications/reject",
        },
        underProcess: {
          hired: "https://thrive-xbzt.onrender.com/api/company/applications/hire",
          rejected: "https://thrive-xbzt.onrender.com/api/company/applications/reject-under-process",
        },
        rejected: {
          underProcess: "https://thrive-xbzt.onrender.com/api/company/applications/move-rejected-to-under-process",
        }
      };
...
const fetchDeveloperProfile = async (developerId) => {
  try {
    const response = await axios.get(`https://thrive-xbzt.onrender.com/api/company/applications/developer/${developerId}`, { params: { jobId }});
                      ...
                      <td>
                        <div className="candidate-info">
                          {applicant.profilePhoto ? (
                            <img src={`https://thrive-xbzt.onrender.com${applicant.profilePhoto}`} alt="Profile" className="profile-photo" />
                          ) : (
                  ...
                  <div className="company-applicant-left-column">
                    ...
                    <div className="company-applicant-profile-header">
                      {selectedProfile.profilePhoto ? (
                        <img src={`https://thrive-xbzt.onrender.com${selectedProfile.profilePhoto}`} alt="Profile" className="company-applicant-profile-photo" />
                      ) : (
