...
const CompanySettings = () => {
  ...
  const handleUpdateEmail = async () => {
    try {
      ...
      const response = await axios.put(
        "https://thrive-xbzt.onrender.com/api/company/settings/update-email",
        { newEmail: email },
        {
  ...
  const handleChangePassword = async () => {
    try {
      setLoading(true);
      const response = await axios.put(
        "https://thrive-xbzt.onrender.com/api/company/settings/update-password",
  ...
  const handleUpdateCompanyName = async () => {
    try {
      setLoading(true);
      const response = await axios.put(
        "https://thrive-xbzt.onrender.com/api/company/settings/change-name",
        { newName: companyName },
        {
          headers: { companyid: companyId },
        }
  ...
  const handleDeleteAccount = async () => {
    try {
      setLoading(true);
      const response = await axios.delete("https://thrive-xbzt.onrender.com/api/company/settings/delete-account", {
        headers: { companyid: companyId },
      });
      setMessage(response.data.message);
