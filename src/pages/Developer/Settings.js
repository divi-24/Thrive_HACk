...
const Settings = () => {
  ...
  const handleUpdateEmail = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        "https://thrive-xbzt.onrender.com/api/developer/settings/update-email",
        { newEmail: email },
        {
  ...
  const handleChangePassword = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.put(
        "https://thrive-xbzt.onrender.com/api/developer/settings/change-password",
  ...
  const handleUpdatePhoneNumber = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.put(
        "https://thrive-xbzt.onrender.com/api/developer/settings/update-phone",
  ...
  const handleDeleteAccount = async () => {
    try {
      ...
      const response = await axios.delete(
        "https://thrive-xbzt.onrender.com/api/developer/settings/delete-account", 
        {
          headers: { "developer-id": developerId }
        }
      );
