...
const Profile = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      await axios.put("https://thrive-xbzt.onrender.com/api/developer/profile", updatedData, {
        headers: { "developer-id": developerId },
      });
  ...
  const handleProfilePhotoUpload = async (e) => {
    ...
    try {
      const response = await axios.put("https://thrive-xbzt.onrender.com/api/developer/uploadProfilePhoto", formData, {
        ...
        <aside className="sidebar">
          <div className="profile-photo-profile">
            {profile.profilePhoto ? (
              <img src={`https://thrive-xbzt.onrender.com${profile.profilePhoto}`} alt="Profile" />
            ) : (
